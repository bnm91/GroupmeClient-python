...
# def getGroups(page, per_page):
#     url = URL_BASE + '/groups' + TOKEN_QUERY_STRING +  '&page=' + str(page)
#     r = requests.get(url)
#     try:
