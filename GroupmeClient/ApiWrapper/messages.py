...
class Messages:
    ...
    def create(self, **kwargs):
        ...
        for key, value in kwargs.items():
            if key == 'source_guid':
                ...
                #TODO: each type is required to be a specifice string, implement checks for that
    ...
    #     url = URL_BASE + '/messages/' + str(self.groupId) + '/' + str(message_id) + '/unlike' + TOKEN_QUERY_STRING
    #     r = requests.post(url)
    #     return self.parse_response_from_json(r)
